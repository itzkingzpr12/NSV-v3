...
aws ecs update-service --cluster disc-$CI_ENVIRONMENT_NAME-bots --service bot-$CI_ENVIRONMENT_NAME-nsm3 --task-definition bot-$CI_ENVIRONMENT_NAME-nsm3 --region $AWS_REGION --force-new-deployment